    ...
    // ── 第二部分：互动模式维度 ──
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "single",
          question: "当你父母对伴侣提出要求对方毕业后必须回家乡考公，而伴侣向你抱怨时，你会？",
          options: [
            { value: "A", label: "如实转达双方意见，尽量减少双方沟通中信息损失" },
            { value: "B", label: "告诉父母「这是我们俩的事」，同时安抚伴侣" },
            { value: "C", label: "分别劝说，向父母美化伴侣，向伴侣解释父母苦心" },
            { value: "D", label: "和伴侣沟通父母的想法，希望双方能一起解决父母的疑虑" },
            { value: "E", label: "和伴侣一起制定应对策略，统一立场后与父母沟通" },
          ],
        },
        {
          id: "intimacy_warmth",
      ...
      questions: [
        {
          ...
          note: "可以是任何引以为傲的方面：身高180、985在读、长相优异、家庭物质支持充足、情绪极其稳定、做饭好吃、家庭氛围开明、职业规划清晰等",
